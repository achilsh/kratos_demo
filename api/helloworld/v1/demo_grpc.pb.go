...
type DemoClient interface {
	...
	// Sends a greeting
	DemoReq(ctx context.Context, in *CreateDemoRequest, opts ...grpc.CallOption) (*CreateDemoReply, error)
}
...
func (c *demoClient) DemoReq(ctx context.Context, in *CreateDemoRequest, opts ...grpc.CallOption) (*CreateDemoReply, error) {
	out := new(CreateDemoReply)
	err := c.cc.Invoke(ctx, "/api.helloworld.v1.Demo/DemoReq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServer) DemoReq(context.Context, *CreateDemoRequest) (*CreateDemoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DemoReq not implemented")
}
...
func _Demo_DemoReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).DemoReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.helloworld.v1.Demo/DemoReq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).DemoReq(ctx, req.(*CreateDemoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
